...
#ifndef EUTELTimepix3DETECTOR_H_
#define EUTELTimepix3DETECTOR_H_
...
namespace eutelescope {
  ...
  class EUTelTimepix3Detector : public EUTelPixelDetector {

  public:
    //! Default constructor
    EUTelTimepix3Detector() ;

    //! Default destructor
    virtual ~EUTelTimepix3Detector() {;}
...
#endif /* EUTELTimepix3DETECTOR_H_ */
